...
# Mapping of azure.ai.ml.constants._common.ConnectionTypes to a snake-case
# representation for Azure Cognitive Services
# azure.mgmt.cognitiveservices.models._cognitive_services_management_client_enum.ConnectionCategory
